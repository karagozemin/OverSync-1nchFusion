          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="inline-flex items-center space-x-1 px-3 py-1.5 bg-yellow-100 dark:bg-yellow-800/30 text-yellow-800 dark:text-yellow-200 text-xs font-medium rounded-md hover:bg-yellow-200 dark:hover:bg-yellow-700/40 transition-colors"
              >
              ...
              <a
                ...
                className="inline-flex items-center space-x-1 px-3 py-1.5 bg-blue-100 dark:bg-blue-800/30 text-blue-800 dark:text-blue-200 text-xs font-medium rounded-md hover:bg-blue-200 dark:hover:bg-blue-700/40 transition-colors"
              >
              ...
              <div className="mt-4 space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <div className="space-y-2">
                    <h5 className="text-xs font-medium text-yellow-700 dark:text-yellow-300 flex items-center space-x-1">
                      <span>🦊</span>
                    ...
                    <div className="space-y-1">
                      {faucets.ethereum.map((faucet, index) => (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center justify-between p-2 bg-white dark:bg-gray-800 rounded border border-yellow-200 dark:border-yellow-800 hover:bg-yellow-50 dark:hover:bg-yellow-900/10 transition-colors text-xs"
                        >
                          <div>
