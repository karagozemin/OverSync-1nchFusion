        ...
        <div className="absolute z-10 mt-1 w-full bg-slate-800/95 backdrop-blur-xl rounded-xl border border-white/20 shadow-2xl overflow-hidden">
          ...
          <div className="p-3 border-b border-white/10">
            <input
              ...
              className="w-full bg-slate-700/50 border border-white/10 rounded-lg px-3 py-2 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
              autoFocus
            />
          </div>
