 ...
 */
const { Horizon, Keypair, Asset, Operation, TransactionBuilder, Networks, BASE_FEE, Claimant } = require('@stellar/stellar-base');
...
async function testClaimableBalance() {
  try {
    ...
    const recipientPubKey = 'GCDARJFKKSTJYAZC647H4ZSSSPXPPSKOWOHGMUNCT22VG74KXZ5BHVNR';
